  ...
  <div id="home">
    ...
    <div class="public cl">
      <div class="person_home">
        <div class="info_set">
          <div class="line"></div>
          <p class="p_title2"><i class="el-icon-video-play"></i>发视频</p>
          <p class="p_title1"  @click="topublish"><i class="el-icon-edit"></i>发帖</p>
          ...
          <div class="chanel">
            ...
            <div class="video_box">
                <el-upload
                    :headers = "Myheaders"
                    :action="publishImgUrl"
                    :on-success="handleAvatarSuccess"
                    :before-upload="beforeAvatarUpload"
                    :show-file-list = "showList">
                    <el-button size="small" type="primary">添加视频</el-button>
                </el-upload>
                <span style="font-size:14px;width:100%;text-algin:left;color:red">视频格式:'mp4', 'ogg', 'flv','avi','wmv','rmvb';限制个数*1</span>
                <div>
