<template>
  <div class="login1" clearfix>
    ...
    <div class="home_top">
      <div class="inset">
        <div class="step">
          <div class="step_div" :class="{'isactive':oneflag}">
            <div :class="oneflag ? 'step0ne_img' : 'step0ne_imgbg'"></div>
          </div>
          <div class="step_div" :class="{'isactive':twoflag}">
            <div :class="twoflag ? 'stepTwo_img' : 'stepTwo_imgbg'"></div>
          </div>
          <div class="step_div" :class="{'isactive':threeflag}">
  ...
  .home_top {
    ...
    .inset {
      ...
      .step {
        ...
        .isactive{
          border-bottom: 2px solid #F0D58E;
        }
        .step0ne_img {
          background: url("../../image/imgs/confirmuser.png") no-repeat;
          background-size: 100%;
          
        }
        .step0ne_imgbg {
          background: url("../../image/imgs/confirmuserbg.png") no-repeat;
          background-size: 100%;
        }
        .stepTwo_img {
          background: url("../../image/imgs/safecheck.png") no-repeat;
          background-size: 100%;
        }
        .stepTwo_imgbg {
          background: url("../../image/imgs/safecheckbg.png") no-repeat;
          background-size: 100%;
        }
        .stepThree_img {
          background: url("../../image/imgs/resetpass.png") no-repeat;
          background-size: 100%;
        }
        .stepThree_imgbg {
          background: url("../../image/imgs/resetpassbg.png") no-repeat;
          background-size: 100%;
        }
      }
      .login-wrap {
